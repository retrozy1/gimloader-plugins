 ...
 * @author retrozy
 * @version 1.0.0
 * @downloadUrl https://raw.githubusercontent.com/retrozy1/gimloader-plugins/main/plugins/STProps.js
 * @gamemode creative
 */
...
api.net.onLoad(() => {
  ...
  if (worldOptions.hasAllProps) {
    ...
    api.net.colyseus.on(
      "ALL_PROPS",
      (props) => removeSeasonTicket(props, worldOptions.propsOptions)
    );
  }
