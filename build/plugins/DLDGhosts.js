 ...
 * @author retrozy
 * @version 0.1.0
 * @downloadUrl https://raw.githubusercontent.com/retrozy1/gimloader-plugins/main/build/plugins/DLDGhosts.js
...
var IS_XHTML =
	/* @__PURE__ */ globalThis.document?.contentType?.includes('xml') ?? false;
var TEXT_NODE = 3;
var COMMENT_NODE = 8;
...
function proxy(value) {
	...
	var version = state(0);
	var stack2 =
		dev_fallback_default && tracing_mode_flag ? get_error('created at') : null;
...
function merge_text_nodes(text2) {
	...
	while (next2 !== null && next2.nodeType === TEXT_NODE) {
		next2.remove();
		text2.nodeValue += /** @type {string} */ next2.nodeValue;
...
var root_2 = from_html(
	`<tr><td><input type="checkbox"/></td><td><select><option>On Teleport</option><option>On Movement</option></select></td><td><input/></td><td><input/></td><td><button title="Delete Ghost"><i class="fas fa-trash"></i></button></td></tr>`
);
var root_1 = from_html(
	`<table><thead><tr><th>Enabled</th><th>Start Mode</th><th>Name</th><th>Skin ID</th><th></th></tr></thead><tbody></tbody></table>`
);
var root = from_html(
	`<!> <div class="flex items-center justify-center"><button class="border-2 rounded-md">Upload Input Recording</button></div>`,
	1
);
